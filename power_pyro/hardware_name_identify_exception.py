...
class HardwareNameIdentifyException(Exception):
    ...
    Args:
        hardware_type (HardwareType): The type of the hardware that could not be identified.
        msg (str): Descriptive error message (optional, default is "Unable to identify hardware name").
    """
